...
<html>
    ...
    <body>
        ...
        <div class="container font-size-controller">
            <div class="row">
                <div class="col-xs-12">
                    <h3 id="synthesis-facilities">Synthesis Facilities</h3>
                    <div class="spacer-1em"></div>
                    <ul class="list-cards row chocolat-parent" data-chocolat-title="Synthesis Facilities" id="synthesis-facilities-grid" data-columns>
                        <li>
                            <a class="chocolat-image" href="img/facilities/clean-room.jpg" title="Clean Room Class 100">
                        ...
                        <li>
                            <a class="chocolat-image" href="img/facilities/gas-mixing-panel.jpg" title="State of the art automatic gas mixing panel">
                        ...
                        <li>
                            <a class="chocolat-image" href="img/facilities/annealing-furnace.jpg" title="Nano-synthesis unit and annealing furnaces (up to 1700 C)">
                        ...
                        <li>
                            <a class="chocolat-image" href="img/facilities/spin-processor.jpg" title="Thin and ultra-thin films spin processor">
                        ...
                        <li>
                            <a class="chocolat-image" href="img/facilities/atomic-layer-deposition.jpg" title="Atomic Layer Deposition and Metal Organic Chemical Vapour Deposition Systems">
